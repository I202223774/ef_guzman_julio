...
class SpringframeworkInitialApplicationTests {
    ...
    void insertarEmpleado() {
        ...
        empleado.setNombre("Jorge Jiménez");
        empleado.setSalario(new BigDecimal("2000.00"));
        empleado.setFechaIngreso(Date.valueOf(LocalDate.now()));
    ...
    void actualizarEmpleado() {
        ...
        empleado.setNombre("Julio Guzman");
        ...
        assertThat(empleadoActualizado.getNombre()).isEqualTo("Julio Guzman");
    }

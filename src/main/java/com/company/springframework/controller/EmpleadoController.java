...
public class EmpleadoController {
    ...
    public ResponseEntity<byte[]> visualizarReporteempleado() throws JRException {
        ...
        JasperPrint jasperPrint = JasperFillManager.fillReport("src/main/resources/reportes/empleado.jasper", parameters, dataSource);
    ...
    @GetMapping("/reporteempleado02")
    public ResponseEntity<byte[]> descargarReporteempleado() throws JRException {
        JasperReport report = JasperCompileManager.compileReport("src/main/resources/reportes/empleado.jrxml");
        JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(empleadoService.listarTodosLosEmpleados());
        Map<String, Object> parameters = new HashMap<>();
        parameters.put("titulo", "Reporte de Empleados");
